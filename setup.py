...
setup(
    name=name,  # Required
    version=get_version("json_reader/__init__.py"),  # Required
    # This is a one-line description or tagline of what your project does.
    description="Read JSON and it's variants from a char stream.",  # Required
    ...
    keywords="json,compiler,reader,stream",  # Optional
